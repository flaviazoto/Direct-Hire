...
import { LayoutGrid, Search, User, ClipboardList, CreditCard } from 'lucide-react'

const ACCENT     = '#7c3aed'
const ACCENT_RGB = '124,58,237'

const tabs = [
  { href: '/worker/dashboard',    label: 'Home',     Icon: LayoutGrid    },
  { href: '/worker/jobs',         label: 'Jobs',     Icon: Search        },
  { href: '/worker/profile',      label: 'Profile',  Icon: User          },
  { href: '/worker/applications', label: 'Apps',     Icon: ClipboardList },
