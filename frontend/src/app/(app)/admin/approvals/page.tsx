...
function AdminApprovalsContent() {
  ...
  return (
    <div className="min-h-screen px-4 sm:px-6 pt-6 pb-8 md:px-8" style={{ maxWidth: 1100 }}>
      ...
      {!loading && totalPages > 1 && (
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginTop: 24, flexWrap: "wrap" }}>
          <span style={{ color: C.muted, fontSize: 13 }}>Showing {submissions.length} of {total}</span>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
