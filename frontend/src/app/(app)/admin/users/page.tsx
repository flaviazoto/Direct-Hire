...
function SuspendModal({ onConfirm, onCancel, loading }: { onConfirm: (r: string) => void; onCancel: () => void; loading: boolean }) {
  ...
  return (
    <div className="glass-scrim" style={{ zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }} onClick={onCancel}>
...
function ReinstateModal({ onConfirm, onCancel, loading }: { onConfirm: () => void; onCancel: () => void; loading: boolean }) {
  return (
    <div className="glass-scrim" style={{ zIndex: 200, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }} onClick={onCancel}>
      <div className="glass-modal" style={{ width: "100%", maxWidth: 360, padding: 28, textAlign: "center" }} onClick={e => e.stopPropagation()}>
    ...
    <div className="admin-page-root min-h-screen px-4 sm:px-6 pt-6 pb-8 md:px-8" style={{ maxWidth: 1100 }}>
      ...
      {!loading && totalPages > 1 && (
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 8, marginTop: 24, flexWrap: "wrap" }}>
          <span style={{ color: C.muted, fontSize: 13 }}>Showing {users.length} of {total.toLocaleString()}</span>
