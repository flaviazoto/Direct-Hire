"use client";
// src/app/(app)/employer/notifications/page.tsx
// Notifications redesign — employer's full notifications page. Same
// pattern as /worker/notifications/page.tsx (card layout, date-grouping,
// shared icon map, pagination, mark-one/mark-all, error/empty states),
// adapted to employerApi and employer's violet accent (#7C3AED/#A78BFA,
// matching DashboardHeader's ROLE_ACCENT.employer).
...
export default function EmployerNotificationsPage() {
  ...
  const load = useCallback(async (p: number, unread: boolean) => {
    ...
    const res = await employerApi.getNotifications(params);
                  ...
                  >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 3 }}>
                        ...
                        {!n.isRead && (
                          <span style={{ flexShrink: 0, fontSize: 10, fontWeight: 700, color: "#A78BFA", background: "rgba(124,58,237,0.15)", border: "1px solid rgba(124,58,237,0.3)", borderRadius: 20, padding: "1px 7px" }}>New</span>
                        )}
                      </div>
